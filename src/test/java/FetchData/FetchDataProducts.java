    ...
    public void testFetchDataProducts() {
        Product[] expectedProducts = {
                ...
                new Product(
                        ...
                        new BigDecimal("168"),
                        "Satisfaction Guaranteed. Return or exchange any order within 30 days.Designed and sold by Hafeez Center in the United States. Satisfaction Guaranteed. Return or exchange any order within 30 days.", "jewelery",
        ...
        List<Product> actualProducts = FetchDataAPI.fetchData("https://fakestoreapi.com/products", Product[].class);
